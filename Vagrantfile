...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "franklinwebber-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/frank-chef-aar"
  #   chef.validation_client_name = "frank-chef-aar-validator"
  #   chef.validation_key_path = ".chef/frank-chef-aar-validator.pem"
  # end
end
